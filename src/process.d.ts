declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    SLACK_OPERATION_WEBHOOK_URL: string;
    ...
    NEXT_PUBLIC_FIREBASE_SCANNED_RECORDS_COLLECTION_NAME: string;
    ...
    NEXT_PUBLIC_DISTANCE_RESTAURANT_TO_DELIVERY_ADDRESS: string;
    ...
    NEXT_PUBLIC_MAX_ORDER_DETAIL_MODIFIED_PERCENT: string;
    ...
    NEXT_PUBLIC_SECONDARY_FOOD_ALLOWED_COMPANIES: string;

    NEXT_PUBLIC_HIDDEN_REVIEWS_USER_IDS: string;
  }
}
